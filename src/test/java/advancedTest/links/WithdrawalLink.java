...
public class WithdrawalLink extends ResourcesConnector {

    @ParameterizedTest
    @ValueSource(strings = {"kievphp"})
    public void GetLinksWithdrawal(String wl) throws IOException  {

        AuthWeb postAuth = new AuthWeb();
        postAuth.authPost(wl);

        Request request = new Request.Builder()
                .url(getProperty(wl, "labelUrl") + "links/withdrawal")
        ...
        assertTrue(link.contains("withdrawal"));
